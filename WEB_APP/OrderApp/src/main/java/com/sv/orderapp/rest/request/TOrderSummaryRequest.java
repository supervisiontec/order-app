 ...
 */
public class TOrderSummaryRequest {
    ...
    private List<TOrderDetailRequest> orderDetails;
    ...
    public List<TOrderDetailRequest> getOrderDetails() {
        return orderDetails;
    }

    public void setOrderDetails(List<TOrderDetailRequest> orderDetails) {
