...
<section class="content-header">
    <h1>
        ...
        <small>view customer information and other options</small>
    ...
    <div class="box box-primary">
        <div class="box-header with-border">
            ...
            <div class="pull-right" >
                <a class="btn btn-xs btn-success" href="${pageContext.request.contextPath}/app/customer-form/new"><i class="fa fa-plus"></i>&nbsp;New Customer</a>
            </div>
        </div>
                ...
                <tbody>
                    <c:forEach items="${transactors}" var="i" varStatus="loop">
                        <tr id="row-${i.indexNo}">
                            ...
                            <td>
                                <a class="btn btn-xs btn-primary"  href="${pageContext.request.contextPath}/app/customer-form/view/${i.indexNo}">View</a>
                                <a class="btn btn-xs btn-warning" href="${pageContext.request.contextPath}/app/customer-form/edit/${i.indexNo}">Edit</a>
...
<script>
    <jsp:include page="customer-list.js"/>
</script>
