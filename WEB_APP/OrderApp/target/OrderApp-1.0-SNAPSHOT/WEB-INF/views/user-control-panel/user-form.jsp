    ...
    <div class="box box-primary">
        ...
        <div class="box-body  no-padding" id="item-list">
            ...
            <div class="col-lg-6">
                ...
                <input type="text"  class="form-control" id="username" placeholder="Input username here" value="${user.username}">
            </div>

            <div class="col-lg-6">
                <label for="username">Password</label>
                <input type="password"  class="form-control" id="password" placeholder="Input password here" value="${user.password}">
            </div>
