...
function saveTransactor() {
    ...
    $.ajax({
        ...
        datatype: 'json',
        processData: false,
        url: rootPath + "/rest/new-supplier",
        success: function (data, textStatus) {
            clear();

            $.toaster({priority: "info", title: 'OK', message: "Supplier saved successfully !"});
        }
    });
}
...
function updateTransactor() {
    ...
    $.ajax({
        ...
        datatype: 'json',
        processData: false,
        url: rootPath + "/rest/update-supplier",
        success: function (data, textStatus) {
            $.toaster({priority: "info", title: 'OK', message: "Supplier updated successfully !"});
        }
    });
}
