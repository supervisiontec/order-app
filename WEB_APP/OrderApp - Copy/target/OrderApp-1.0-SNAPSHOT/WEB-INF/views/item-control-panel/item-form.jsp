    ...
    <div class="box box-primary">
        ...
        <div class="box-body" id="item-form">
            ...
            <div class="form-group col-lg-2">
                ...
                <input type="number" class="form-control" id="wholeSalePrice" placeholder="Enter whole sale price" value="${item.wholeSalePrice}">
            </div>

            <div class="form-group col-lg-2">
                <label for="lastSalePrice">Last Sale Price</label>
                <input type="number" class="form-control" id="lastSalePrice" placeholder="Enter last sale price" value="${item.lastSalePrice}">
            </div>

            <div class="form-group col-lg-2">
                <label for="salePrice">Sale Price</label>
                <input type="number" class="form-control" id="salePrice" placeholder="Enter sale price" value="${item.salePrice}">
            </div>
...
<script>
    ...
    var selectedSupplier = '<c:out value="${item==null?'null':item.MTransactor.code}"/>';
