    ...
    <div class="box box-primary">
        ...
        <div class="box-body  no-padding" id="item-list">
            ...
            <div class="form-group col-lg-4">
                ...
                <input type="text"  class="form-control" id="code" placeholder="Input code here" value="${transactor.code}">
            </div>
        ...
        <div class="box-footer">
            <c:if test="${action=='new'}">
                ...
                <a type="button" class="btn btn-default" href="${pageContext.request.contextPath}/app/customer-list">
...
<script>
    ...
    var selectedRoute = <c:out value="${transactor!=null?transactor.MRoute.indexNo:'null'}"/>;
