...
public class MUser implements java.io.Serializable {
    ...
    public MUser(String name, boolean itemControlPanel, boolean customerControlPanel, boolean supplierControlPanel, boolean userControlPanel, boolean customerApproval, boolean orderApproval, boolean reports, boolean active) {
        this.name = name;
